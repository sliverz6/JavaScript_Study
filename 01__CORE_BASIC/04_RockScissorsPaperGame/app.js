...
combine(showResult.bind(this, 'The result after adding all numbers is:'), 'SUM', 5, 'asd', -3, 6, 10);
combine(showResult.bind(this, 'The result after adding all numbers is:'), 'SUM', 5, 10, -3, 6, 10, 25, 88);
